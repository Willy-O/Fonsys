    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{ route('clousures.update', $clousure->id)}}" method="PUT">
                        {{ csrf_field() }}
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <textarea name="efects" class="form-control @error('efects') is-invalid @enderror" id="efects" cols="30" rows="3">{{ $clousure->results }}</textarea>
                            </div>
                        </div>
