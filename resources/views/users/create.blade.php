                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route('users.store')}}">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input id="cedula" type="number" class="form-control @error('cedula') is-invalid @enderror" min="0" name="cedula" value="{{ old('cedula') }}" required autofocus>
                    ...
                    <div class="card card-header">{{ __('Datos de usuario') }}</div>
                        ...
                        <div class="card-footer">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <select name="rol" id="rol" class="form-control @error('password') is-invalid @enderror">
                                        <option value=""></option>
